  ...
  try {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: FROM_EMAIL,
        to: [email],
        subject: `💸 Withdrawal ${statusConfig.text} - ${formattedAmount} | TeslaInvest`,
        html: `
          <!DOCTYPE html>
          <html>
          <head>
                      ...
                      <td style="padding: 0 40px 40px;">
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="40" style="vertical-align: top;">
                                      <div style="background: ${status === 'pending' || status === 'processing' || status === 'completed' ? '#22c55e' : '#404040'}; width: 24px; height: 24px; border-radius: 50%; text-align: center; line-height: 24px; font-size: 12px; color: white;">✓</div>
                                    </td>
                                    <td>
                                      <div style="color: #ffffff; font-weight: 600; font-size: 14px;">Request Received</div>
                                      <div style="color: #737373; font-size: 12px;">Your withdrawal request has been submitted</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td style="padding: 12px 0;">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="40" style="vertical-align: top;">
                                      <div style="background: ${status === 'processing' || status === 'completed' ? '#22c55e' : '#404040'}; width: 24px; height: 24px; border-radius: 50%; text-align: center; line-height: 24px; font-size: 12px; color: white;">${status === 'processing' || status === 'completed' ? '✓' : '2'}</div>
                                    </td>
                                    <td>
                                      <div style="color: ${status === 'processing' || status === 'completed' ? '#ffffff' : '#737373'}; font-weight: 600; font-size: 14px;">Processing</div>
                                      <div style="color: #737373; font-size: 12px;">Funds are being transferred (1-3 business days)</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td style="padding: 12px 0;">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="40" style="vertical-align: top;">
                                      <div style="background: ${status === 'completed' ? '#22c55e' : '#404040'}; width: 24px; height: 24px; border-radius: 50%; text-align: center; line-height: 24px; font-size: 12px; color: white;">${status === 'completed' ? '✓' : '3'}</div>
                                    </td>
                                    <td>
                                      <div style="color: ${status === 'completed' ? '#ffffff' : '#737373'}; font-weight: 600; font-size: 14px;">Completed</div>
                                      <div style="color: #737373; font-size: 12px;">Funds deposited to your account</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                        ...
                        <div style="border-left: 4px solid #fbbf24; padding-left: 20px; margin: 30px 0;">
                          <p style="color: #a3a3a3; font-size: 14px; line-height: 1.6; margin: 0;">
                            <strong style="color: #fbbf24;">Security Notice:</strong> If you didn't request this withdrawal, 
    ...
    console.log("Withdrawal confirmation email sent successfully:", data);
