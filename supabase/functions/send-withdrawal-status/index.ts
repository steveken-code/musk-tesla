              ...
              <tr>
                <td style="padding: 50px 50px 40px; text-align: center; background: linear-gradient(135deg, #dc2626 0%, #b91c1c 50%, #991b1b 100%);">
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <tr><td align="center" style="color: #ffffff; font-size: 18px; font-weight: 600; padding-top: 10px;"><span style="color: #ffffff;">${status === 'completed' ? 'Transaction Receipt' : 'Withdrawal Status Update'}</span></td></tr>
                  </table>
                </td>
              </tr>
