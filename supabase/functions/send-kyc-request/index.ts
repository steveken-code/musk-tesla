    ...
    const emailHtml = `
      ...
      <html>
        ...
        <body style="margin: 0; padding: 0; background-color: #f3f4f6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f3f4f6; min-width: 100%; page-break-inside: avoid;">
            <tr>
              <td align="center" style="padding: 40px 20px;">
                <table role="presentation" width="650" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #e5e7eb;">
                  ...
                  <tr>
                    <td style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 50%, #991b1b 100%); padding: 32px 40px; text-align: center;">
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                        <tr><td align="center" style="color: #ffffff; font-size: 26px; font-weight: 800; letter-spacing: -0.5px;"><span style="color: #ffffff;">🔐 Identity Verification Required</span></td></tr>
                        <tr><td align="center" style="color: #ffffff; font-size: 14px; padding-top: 10px;"><span style="color: #ffffff;">Tesla Stock Brokerage Platform</span></td></tr>
                      </table>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
                        Hello <span style="color: #3b82f6; font-weight: 700;">${userName}</span>,
                      </p>

                      <p style="color: #374151; font-size: 15px; line-height: 1.7; margin: 0 0 24px 0;">
                        To comply with international <strong style="color: #111827;">Anti-Money Laundering (AML)</strong> and 
                        <strong style="color: #111827;">Counter-Terrorist Financing (CTF)</strong> regulations, we require a 
                        ...
                        <tr>
                          <td align="center">
                            <a href="${verificationUrl}" 
                               style="display: inline-block; background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 14px rgba(220, 38, 38, 0.4);">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; margin: 24px 0;">
                        <tr>
                          <td style="padding: 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                              <tr><td style="color: #3b82f6; font-size: 14px; font-weight: 700; padding-bottom: 16px; text-transform: uppercase; letter-spacing: 0.5px;"><span style="color: #3b82f6;">📋 Requirements</span></td></tr>
                            </table>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                              <tr>
                                <td style="padding: 6px 0; color: #374151; font-size: 14px; line-height: 1.8;">
                                  <span style="color: #111827; font-weight: 700;">• Government-Issued ID:</span> <span style="color: #374151;">A clear, color scan of your Passport, National ID, or Driver's License</span>
                                </td>
                              </tr>
                              <tr>
                                <td style="padding: 6px 0; color: #374151; font-size: 14px; line-height: 1.8;">
                                  <span style="color: #111827; font-weight: 700;">• Tax Identification:</span> <span style="color: #374151;">${taxIdLabel}</span>
                                </td>
                              </tr>
                            </table>
                          </td>
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; margin: 24px 0;">
                        <tr>
                          <td style="padding: 24px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                              <tr><td style="color: #3b82f6; font-size: 14px; font-weight: 700; padding-bottom: 16px; text-transform: uppercase; letter-spacing: 0.5px;"><span style="color: #3b82f6;">📊 Transaction Details</span></td></tr>
                            </table>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                              <tr>
                                <td style="color: #6b7280; font-size: 13px; padding: 8px 0; border-bottom: 1px solid #e5e7eb;">Reference</td>
                                <td style="color: #111827; font-size: 13px; padding: 8px 0; text-align: right; font-weight: 700; border-bottom: 1px solid #e5e7eb;">${transactionRef}</td>
                              </tr>
                              <tr>
                                <td style="color: #6b7280; font-size: 13px; padding: 8px 0; border-bottom: 1px solid #e5e7eb;">Withdrawal Amount</td>
                                <td style="color: #059669; font-size: 13px; padding: 8px 0; text-align: right; font-weight: 700; border-bottom: 1px solid #e5e7eb;">${formattedAmount}</td>
                              </tr>
                              <tr>
                                <td style="color: #6b7280; font-size: 13px; padding: 8px 0; border-bottom: 1px solid #e5e7eb;">Country</td>
                                <td style="color: #111827; font-size: 13px; padding: 8px 0; text-align: right; font-weight: 600; border-bottom: 1px solid #e5e7eb;">${countryName}</td>
                              </tr>
                              <tr>
                                <td style="color: #6b7280; font-size: 13px; padding: 8px 0;">Status</td>
                                <td style="padding: 8px 0; text-align: right;">
                                  <span style="background-color: #fef3c7; color: #92400e; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 700;">
                      ...
                      <p style="color: #374151; font-size: 14px; line-height: 1.6; margin: 24px 0 0 0;">
                        Your funds are currently held in a secured <strong style="color: #92400e;">'Pending'</strong> status 
                    ...
                    <td style="padding: 0 40px 24px;">
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 10px;">
                        <tr><td style="padding: 20px; text-align: center;">
                          <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                            <tr><td align="center" style="color: #111827; font-size: 15px; font-weight: 700; padding-bottom: 6px;"><span style="color: #111827;">Need Assistance?</span></td></tr>
                  ...
                  <tr>
                    <td style="padding: 16px 40px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; text-align: center;">
                      ...
                      <p style="color: #9ca3af; font-size: 11px; margin: 8px 0 0 0;">&copy; 2026 Tesla Stock Platform. All rights reserved. &nbsp;&#8226;&nbsp; Confidential communication.</p>
                    </td>
                  </tr>
                </table>
              </td>
