...
import { FROM_EMAIL, HEADER_GRADIENT, FONT_FAMILY } from "../_shared/email-constants.ts";
...
<body style="margin: 0; padding: 0; background-color: #0f0f0f; font-family: ${FONT_FAMILY};">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #0f0f0f;">
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table role="presentation" width="650" cellspacing="0" cellpadding="0" style="max-width: 650px; width: 100%; background: linear-gradient(180deg, #1a1a1a 0%, #0f0f0f 100%); border-radius: 16px; overflow: hidden; border: 1px solid #2a2a2a;">
                  ...
                  <td style="padding: 24px;">
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td style="color: #22c55e; font-size: 18px; padding: 10px 0; text-align: right; font-weight: 700; border-bottom: 1px solid #2a2a2a;">${formattedAmount}</td>
                      </tr>
                      <tr>
