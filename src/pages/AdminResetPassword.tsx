...
import { ArrowLeft, Lock, Loader2, Eye, EyeOff, CheckCircle, XCircle, Shield } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        <div className="bg-slate-800/90 backdrop-blur-2xl border border-slate-700 rounded-3xl p-10 shadow-2xl shadow-black/50">
          <div className="flex flex-col items-center justify-center mb-8">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-tesla-red/10 border border-tesla-red/30 rounded-full mb-4">
              <Shield className="w-4 h-4 text-tesla-red" />
              <span className="text-xs font-semibold text-tesla-red">Admin Portal</span>
            </div>
            <h2 className="text-xl font-semibold text-white">Create New Admin Password</h2>
            {email && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-tesla-red to-red-700 hover:from-red-700 hover:to-tesla-red text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-tesla-red/25 disabled:opacity-50"
            >
              {loading ? (
