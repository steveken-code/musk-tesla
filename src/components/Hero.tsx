...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-card/50 backdrop-blur-sm border border-border rounded-full hover:bg-card/80 transition-all hover:scale-110"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-card/50 backdrop-blur-sm border border-border rounded-full hover:bg-card/80 transition-all hover:scale-110"
