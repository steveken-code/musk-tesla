...
const Vision = () => {
  ...
  return (
    <section id="about" className="py-24 md:py-32 relative overflow-hidden bg-slate-900">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <Card className="p-6 md:p-8 lg:p-12 bg-slate-800/80 backdrop-blur-sm border border-white/10 shadow-lg group transition-all duration-300 hover:shadow-xl">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1 text-center md:text-left">
                  <blockquote className="text-lg md:text-xl lg:text-2xl font-light leading-relaxed text-gray-200 mb-6 italic">
