        ...
        <div className="max-w-5xl mx-auto">
            ...
            <Card className="p-6 md:p-8 lg:p-12 glass-card group">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                ...
                <div className="flex-1 text-center md:text-left">
                  <blockquote className="text-lg md:text-xl lg:text-2xl font-light leading-relaxed text-white mb-6 italic">
                  ...
                  <div className="flex items-center gap-4 justify-center md:justify-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-sm">CEO, Tesla & SpaceX</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-6 mt-12">
            {[
              ...
              >
                <Card className="p-5 md:p-6 glass-card h-full group">
